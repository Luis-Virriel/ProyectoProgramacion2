...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-4">
        ...
        <asp:GridView ID="gvTecnicos" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="CI"
            AutoGenerateEditButton="True" AutoGenerateDeleteButton="True"
            OnRowEditing="EditarTecnicos" OnRowUpdating="ActualizarTecnicos"
            OnRowDeleting="BorrarTecnicos" OnRowCancelingEdit="CanceloEditarTecnicos">
            <Columns>
