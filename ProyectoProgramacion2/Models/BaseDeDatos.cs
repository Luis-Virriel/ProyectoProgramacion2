...
namespace ProyectoProgramacion2.Models
{
    public abstract class BaseDeDatos
    {
        ...
        {
            new Cliente { Nombre = "Juan", Apellido = "Pérez", CI = "12345678", Direccion = "Calle Falsa 123", Telefono = "555-1234", Email = "juan.perez@example.com" },
            new Cliente { Nombre = "María", Apellido = "González", CI = "87654321", Direccion = "Avenida Siempre Viva 456", Telefono = "555-5678", Email = "maria.gonzalez@example.com" },
            new Cliente { Nombre = "Carlos", Apellido = "Sánchez", CI = "11223344", Direccion = "Calle Real 789", Telefono = "555-9101", Email = "carlos.sanchez@example.com" },
            new Cliente { Nombre = "Ana", Apellido = "Lopez", CI = "22334455", Direccion = "Boulevard de los Sueños 101", Telefono = "555-1213", Email = "ana.lopez@example.com" },
            new Cliente { Nombre = "Luis", Apellido = "Martinez", CI = "33445566", Direccion = "Plaza Mayor 202", Telefono = "555-1415", Email = "luis.martinez@example.com" }
        };
